Shader "Amazing Assets/Curved World/Baked Lit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,12|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_SPIRALHORIZONTAL_X_NEGATIVE
